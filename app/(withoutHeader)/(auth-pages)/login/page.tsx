        ...
        <div className="relative flex-col hidden h-full p-6 pl-8 text-white lg:flex dark:border-r">
          <div className="absolute inset-0">
            <img
              ...
              // priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary to-transparent to-80%"></div>
          </div>
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Ce site est un véritable gain de temps, j'ai pu accéder à
                mes services en toute simplicité grâce à mon compte.&rdquo;
              </p>
              <footer className="text-sm">Youssef</footer>
            </blockquote>
          </div>
        </div>
