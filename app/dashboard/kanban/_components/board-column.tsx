...
import { Task } from "@/src/lib/store"
    ...
    >
      <CardHeader className="flex flex-row items-center p-4 font-semibold text-left border-b-2 space-between">
        <Button
          ...
          {...attributes}
          {...listeners}
          className="relative h-auto p-1 -ml-2  cursor-grab text-primary/50"
        >
      ...
      <CardContent className="flex flex-col flex-grow gap-4 p-2 overflow-x-hidden">
